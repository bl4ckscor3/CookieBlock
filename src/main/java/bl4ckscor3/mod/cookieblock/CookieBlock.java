...
public class CookieBlock {
	...
	public static final RegistryObject<Block> COOKIE_BLOCK = BLOCKS.register(MODID, () -> new Block(BlockBehaviour.Properties.of().strength(0.25F).sound(SoundType.STONE)));
